...
var G__41264 = o;
goog.object.set(G__41264,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__41265 = o;
goog.object.set(G__41265,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__41266 = props;
var G__41266__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41266,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__41266);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41266__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__41267 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41267,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__41267;
}
})(),id_class);
...
var G__41268 = (cljs.core.count(argv) - first_child);
switch (G__41268) {
case (0):
...
var vec__41269 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41269,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41269,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41269,(2),null);
...
var temp__5757__auto___41289 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___41289 == null)){
} else {
var key_41290 = temp__5757__auto___41289;
(jsprops.key = key_41290);
}
...
var temp__5757__auto___41291 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___41291 == null)){
} else {
var key_41292 = temp__5757__auto___41291;
(jsprops.key = key_41292);
}
...
var temp__5757__auto___41295 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___41295 == null)){
} else {
var key_41296 = temp__5757__auto___41295;
(jsprops.key = key_41296);
}
...
var temp__5757__auto___41299 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___41299 == null)){
} else {
var key_41300 = temp__5757__auto___41299;
(jsprops.key = key_41300);
}
...
var temp__5757__auto___41302 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___41302 == null)){
} else {
var key_41303 = temp__5757__auto___41302;
(jsprops.key = key_41303);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41272_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__41272_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__41273 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41273,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41273,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template41279 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template41279 = (function (opts,id,fn_to_element,parse_fn,meta41280){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template41279.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_41281,meta41280__$1){
var self__ = this;
var _41281__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template41279(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta41280__$1));
}));

(reagent.impl.template.t_reagent$impl$template41279.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_41281){
var self__ = this;
var _41281__$1 = this;
return self__.meta41280;
}));

(reagent.impl.template.t_reagent$impl$template41279.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template41279.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template41279.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template41279.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template41279.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template41279.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta41280","meta41280",840358937,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template41279.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template41279.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template41279");

(reagent.impl.template.t_reagent$impl$template41279.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template41279");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template41279.
 */
reagent.impl.template.__GT_t_reagent$impl$template41279 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template41279(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta41280){
return (new reagent.impl.template.t_reagent$impl$template41279(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta41280));
});

}

return (new reagent.impl.template.t_reagent$impl$template41279(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
