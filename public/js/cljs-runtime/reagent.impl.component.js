...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41140 = c;
var G__41140__$1 = (((G__41140 == null))?null:G__41140.prototype);
if((G__41140__$1 == null)){
return null;
} else {
return G__41140__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41141 = c;
var G__41141__$1 = (((G__41141 == null))?null:G__41141.prototype);
if((G__41141__$1 == null)){
return null;
} else {
return G__41141__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__41248__delegate = function (args){
...
while (G__41249__i < G__41249__a.length) {G__41249__a[G__41249__i] = arguments[G__41249__i + 0]; ++G__41249__i;}
  args = new cljs.core.IndexedSeq(G__41249__a,0,null);
} 
return G__41248__delegate.call(this,args);};
G__41248.cljs$lang$maxFixedArity = 0;
G__41248.cljs$lang$applyTo = (function (arglist__41250){
var args = cljs.core.seq(arglist__41250);
return G__41248__delegate(args);
});
...
var or__4212__auto__ = (function (){var G__41159 = c;
var G__41159__$1 = (((G__41159 == null))?null:G__41159.constructor);
if((G__41159__$1 == null)){
return null;
} else {
return G__41159__$1.displayName;
}
})();
...
var G__41160 = c;
var G__41160__$1 = (((G__41160 == null))?null:G__41160.constructor);
if((G__41160__$1 == null)){
return null;
} else {
return G__41160__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__41224 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41225 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41225);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41224);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__41226 = key;
var G__41226__$1 = (((G__41226 instanceof cljs.core.Keyword))?G__41226.fqn:null);
switch (G__41226__$1) {
...
var c = this;
var G__41235_41254 = goog.object.get(c,"cljsRatom");
if((G__41235_41254 == null)){
} else {
reagent.ratom.dispose_BANG_(G__41235_41254);
}
...
var renders_41255 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_41256 = cljs.core.first(cljs.core.vals(renders_41255));
...
if((cljs.core.count(renders_41255) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_41255))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_41256)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_41256], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__41236 = o;
goog.object.set(G__41236,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__41237 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41238 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41238);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41237);
}});
...
var vec__41239 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41239,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41239,(1),null);
...
var G__41242 = goog.object.get(reagent_state,"cljsRatom");
if((G__41242 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__41242);
}
});
}),[]);
