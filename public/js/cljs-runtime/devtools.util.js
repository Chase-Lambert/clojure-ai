...
var _STAR_print_newline_STAR__orig_val__32594_32735 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__32595_32736 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__32596_32737 = true;
var _STAR_print_fn_STAR__temp_val__32597_32738 = (function (x__4750__auto__){
return sb__4749__auto__.append(x__4750__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__32596_32737);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__32597_32738);

try{var _STAR_print_level_STAR__orig_val__32598_32739 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32599_32740 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32599_32740);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32598_32739);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__32595_32736);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__32594_32735);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq32593){
var self__4806__auto__ = this;
return self__4806__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq32593));
}));
...
var new_formatters = current_formatters.filter((function (p1__32641_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__32641_SHARP_)));
}));
...
var G__32643_32743 = f;
var target__30326__auto___32744 = G__32643_32743;
if(cljs.core.truth_(target__30326__auto___32744)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__32643_32743)].join(''),"\n","target__30326__auto__"].join('')));
}

(target__30326__auto___32744["toString"] = (function (){
...
var G__32669_32745 = "%c%s";
var G__32670_32746 = "color:transparent";
var G__32671_32747 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__32669_32745,G__32670_32746,G__32671_32747) : f.call(null,G__32669_32745,G__32670_32746,G__32671_32747));
...
var args__4824__auto__ = [];
var len__4818__auto___32748 = arguments.length;
var i__4819__auto___32749 = (0);
while(true){
if((i__4819__auto___32749 < len__4818__auto___32748)){
args__4824__auto__.push((arguments[i__4819__auto___32749]));

var G__32750 = (i__4819__auto___32749 + (1));
i__4819__auto___32749 = G__32750;
continue;
} else {
}
break;
...
var vec__32702 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32702,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32702,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__32751__delegate = function (add_fmt,add_args){
...
var G__32751 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__32752__i = 0, G__32752__a = new Array(arguments.length -  1);
while (G__32752__i < G__32752__a.length) {G__32752__a[G__32752__i] = arguments[G__32752__i + 1]; ++G__32752__i;}
  add_args = new cljs.core.IndexedSeq(G__32752__a,0,null);
} 
return G__32751__delegate.call(this,add_fmt,add_args);};
G__32751.cljs$lang$maxFixedArity = 1;
G__32751.cljs$lang$applyTo = (function (arglist__32753){
var add_fmt = cljs.core.first(arglist__32753);
var add_args = cljs.core.rest(arglist__32753);
return G__32751__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq32681){
var G__32683 = cljs.core.first(seq32681);
var seq32681__$1 = cljs.core.next(seq32681);
var G__32684 = cljs.core.first(seq32681__$1);
var seq32681__$2 = cljs.core.next(seq32681__$1);
var G__32685 = cljs.core.first(seq32681__$2);
var seq32681__$3 = cljs.core.next(seq32681__$2);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32683,G__32684,G__32685,seq32681__$3);
}));
...
var seq__32711 = cljs.core.seq(features);
var chunk__32712 = null;
var count__32713 = (0);
var i__32714 = (0);
while(true){
if((i__32714 < count__32713)){
var feature = chunk__32712.cljs$core$IIndexed$_nth$arity$2(null,i__32714);
...
var G__32754 = seq__32711;
var G__32755 = chunk__32712;
var G__32756 = count__32713;
var G__32757 = (i__32714 + (1));
seq__32711 = G__32754;
chunk__32712 = G__32755;
count__32713 = G__32756;
i__32714 = G__32757;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__32711);
if(temp__5753__auto__){
var seq__32711__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__32711__$1)){
var c__4638__auto__ = cljs.core.chunk_first(seq__32711__$1);
var G__32758 = cljs.core.chunk_rest(seq__32711__$1);
var G__32759 = c__4638__auto__;
var G__32760 = cljs.core.count(c__4638__auto__);
var G__32761 = (0);
seq__32711 = G__32758;
chunk__32712 = G__32759;
count__32713 = G__32760;
i__32714 = G__32761;
continue;
} else {
var feature = cljs.core.first(seq__32711__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__32762 = cljs.core.next(seq__32711__$1);
var G__32763 = null;
var G__32764 = (0);
var G__32765 = (0);
seq__32711 = G__32762;
chunk__32712 = G__32763;
count__32713 = G__32764;
i__32714 = G__32765;
continue;
}
} else {
...
var G__32718 = feature;
var G__32718__$1 = (((G__32718 instanceof cljs.core.Keyword))?G__32718.fqn:null);
switch (G__32718__$1) {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o32719 = temp__5751__auto__;
return (o32719["version"]);
} else {
return null;
}
})() == null);
