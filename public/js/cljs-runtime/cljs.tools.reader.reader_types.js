...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_33770 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_33770(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_33771 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_33771(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_33772 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_33772(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_33773 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_33773(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_33774 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_33774(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_33775 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_33775(reader);
}
});
...
var G__33782 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__33783 = s.append(c);
c = G__33782;
s = G__33783;
continue;
}
