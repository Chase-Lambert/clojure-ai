...
var o32907 = temp__5751__auto__;
var temp__5751__auto____$1 = (o32907["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o32908 = temp__5751__auto____$1;
return (o32908["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30302__auto__ = f;
return (o__30302__auto__["toString"]).call(o__30302__auto__);
} else {
return "";
}
}catch (e32910){var _ = e32910;
return "";
}});
...
try{var o__30302__auto___33035 = t;
(o__30302__auto___33035["cljs$lang$ctorPrWriter"]).call(o__30302__auto___33035,t,writer);
}catch (e32911){var __33036 = e32911;
}
...
var char_code = (function (){var o__30302__auto__ = (new String(char$));
return (o__30302__auto__["charCodeAt"]).call(o__30302__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30302__auto__ = String;
return (o__30302__auto__["fromCharCode"]).call(o__30302__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__32915 = num_code;
switch (G__32915) {
case (1):
return (185);
...
var o__30302__auto__ = String;
return (o__30302__auto__["fromCharCode"]).call(o__30302__auto__,superscript_code);
});
/**
...
}catch (e32934){var _e__30329__auto__ = e32934;
return false;
}})())){
...
var vec__32935 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32935,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__32953){
var vec__32954 = p__32953;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32954,(0),null);
...
var G__33078 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__33079 = cljs.core.butlast(remaining_tokens);
name_tokens = G__33078;
remaining_tokens = G__33079;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq32951){
var G__32952 = cljs.core.first(seq32951);
var seq32951__$1 = cljs.core.next(seq32951);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32952,seq32951__$1);
}));
...
var vec__32959 = cljs.core.split_with((function (p1__32958_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__32958_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32959,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32959,(1),null);
...
var vec__32965 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32965,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32965,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__33094 = cljs.core.rest(remaining_tokens);
var G__33095 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__33094;
name_tokens = G__33095;
continue;
} else {
...
var vec__32970 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32970,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32970,(1),null);
var vec__32973 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32973,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32973,(1),null);
var vec__32976 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32976,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32976,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32976,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32976,(3),null);
...
var vec__32991 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32991,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32991,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32991,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32991,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32991,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32991,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__32994 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32994,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32994,(1),null);
var vec__32997 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32997,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32997,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__33000 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__33000) : devtools.munging.parse_fn_info_deep.call(null,G__33000));
})()));
}
} else {
return fn_info;
...
var G__33153 = (arity + (1));
var G__33154 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33002,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33002,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33005_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__33005_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33006_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__33006_SHARP_);
}),sorted_infos);
...
var args__4824__auto__ = [];
var len__4818__auto___33251 = arguments.length;
var i__4819__auto___33252 = (0);
while(true){
if((i__4819__auto___33252 < len__4818__auto___33251)){
args__4824__auto__.push((arguments[i__4819__auto___33252]));

var G__33253 = (i__4819__auto___33252 + (1));
i__4819__auto___33252 = G__33253;
continue;
} else {
}
break;
...
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33010,(0),null);
...
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33008,seq33007__$1);
}));
...
var G__33013 = arg;
var G__33013__$1 = (((G__33013 instanceof cljs.core.Keyword))?G__33013.fqn:null);
switch (G__33013__$1) {
...
var map__33014 = options;
var map__33014__$1 = cljs.core.__destructure_map(map__33014);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33014__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33014__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33014__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33014__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33015 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33015,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33015,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33015,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33015,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33015,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33015,(5),null);
...
var o__30302__auto__ = f;
return (o__30302__auto__["getBasis"]).call(o__30302__auto__);
});
/**
...
}catch (e33018){var _e__30329__auto__ = e33018;
...
var G__33257 = (obj[cljs.core.first(path)]);
var G__33258 = cljs.core.rest(path);
obj = G__33257;
path = G__33258;
continue;
} else {
...
var _STAR_ = (function (accum,p__33019){
var vec__33020 = p__33019;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33020,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33020,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__33026){
var vec__33027 = p__33026;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33027,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33027,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33027,(2),null);
...
var post_process = (function (p__33031){
var vec__33032 = p__33031;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33032,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33032,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33030_SHARP_){
return (obj[cljs.core.first(p1__33030_SHARP_)]);
}),sorted_matches);
