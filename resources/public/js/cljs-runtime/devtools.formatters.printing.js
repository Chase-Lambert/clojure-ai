...
var len__4818__auto___33316 = arguments.length;
var i__4819__auto___33317 = (0);
while(true){
if((i__4819__auto___33317 < len__4818__auto___33316)){
args__4824__auto__.push((arguments[i__4819__auto___33317]));

var G__33318 = (i__4819__auto___33317 + (1));
i__4819__auto___33317 = G__33318;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq33291){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33292,G__33293,seq33291__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__33298_SHARP_){
return (!((cljs.core.meta(p1__33298_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33303__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e33304){var _e__30329__auto__ = e33304;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e33306){var _e__30329__auto__ = e33306;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__33308 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__33309 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__33309);

try{var map__33310 = opts;
var map__33310__$1 = cljs.core.__destructure_map(map__33310);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33310__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__33308);
}});
...
var temp__5751__auto___33323 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___33323)){
var managed_print_level_33324 = temp__5751__auto___33323;
var _STAR_print_level_STAR__orig_val__33312_33325 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__33313_33326 = managed_print_level_33324;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__33313_33326);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__33311_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__33311_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__33312_33325);
}} else {
job_fn();
}
