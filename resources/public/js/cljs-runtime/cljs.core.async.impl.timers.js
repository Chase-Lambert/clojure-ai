...
var i_34229 = (self__.level + (1));
while(true){
if((i_34229 <= (new_level + (1)))){
(update[i_34229] = self__.header);

var G__34230 = (i_34229 + (1));
i_34229 = G__34230;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_34231 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_34231[i]));
} else {
x__$2.forward.push((((i < links_34231.length))?(links_34231[i]):null));
}

if((i < links_34231.length)){
(links_34231[i] = x__$2);
} else {
links_34231.push(x__$2);
}
...
var i_34233 = (0);
while(true){
if((i_34233 <= self__.level)){
var links_34234 = (update[i_34233]).forward;
if((x__$1 === (((i_34233 < links_34234.length))?(links_34234[i_34233]):null))){
(links_34234[i_34233] = (x__$1.forward[i_34233]));

var G__34249 = (i_34233 + (1));
i_34233 = G__34249;
continue;
} else {
var G__34250 = (i_34233 + (1));
i_34233 = G__34250;
continue;
}
} else {
...
var G__34252 = nx;
var G__34253 = (level__$1 - (1));
x = G__34252;
level__$1 = G__34253;
continue;
} else {
var G__34254 = x;
var G__34255 = (level__$1 - (1));
x = G__34254;
level__$1 = G__34255;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__34257 = nx;
var G__34258 = (level__$1 - (1));
x = G__34257;
level__$1 = G__34258;
continue;
} else {
var G__34259 = x;
var G__34260 = (level__$1 - (1));
x = G__34259;
level__$1 = G__34260;
continue;
}
